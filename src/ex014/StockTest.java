...
public class StockTest {
	...
	public void tests() {
		...
		assertEquals(10, s.price, 0.001);
		assertEquals(100, s.totalShares);

		assertEquals(0,s.percentChange,0.001);
		assertEquals(1000,s.marketCap, 0.001);

		s.adjustPrice(-5);
		assertEquals(-50,s.percentChange,0.001);
		assertEquals(500,s.marketCap, 0.001);

		s.adjustPrice(3);
		assertEquals(60,s.percentChange,0.001);
		assertEquals(800,s.marketCap, 0.001);
	}
}
